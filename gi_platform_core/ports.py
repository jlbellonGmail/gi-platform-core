...
class CoreStore(Protocol):
    ...
    def get_identity_link(self, entity_id: str) -> IdentityLink | None: ...
    def all_identity_links(self) -> Iterable[IdentityLink]: ...
    def link_identity_atomic(self, entity: IdentityLink) -> IdentityLink: ...
    def unlink_identity_atomic(self, organization_id: str, person_id: str) -> IdentityLink | None: ...
