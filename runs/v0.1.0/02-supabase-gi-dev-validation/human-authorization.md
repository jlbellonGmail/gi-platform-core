# Human authorization — pendiente de decisión

Este archivo queda preparado para la decisión HITL sobre la PR real. No
contiene una decisión y no autoriza merge.

Cuando el mantenedor decida, debe reemplazar este contenido con el formato
