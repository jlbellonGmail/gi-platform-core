# Tasks — Supabase gi-dev validation

- [x] T1: preservar checkout y crear Feature/worktree oficial.
- [x] T2: implementar preflight de destino y autenticación oculta.
- [x] T3: implementar bootstrap idempotente con casos de uso del Core.
